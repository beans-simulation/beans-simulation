...
export declare const Icons: { [K in DefaultIcons]: Icon };
...
export declare function relayout(root: Root, layout: Partial<Layout>): Promise<PlotlyHTMLElement>;
export declare function redraw(root: Root): Promise<PlotlyHTMLElement>;
export declare function purge(root: Root): void;
export declare function restyle(root: Root, aobj: Data, traces?: number[] | number): Promise<PlotlyHTMLElement>;
...
export declare function addTraces(
    root: Root,
    traces: Data | Data[],
    newIndices?: number[] | number,
): Promise<PlotlyHTMLElement>;
export declare function deleteTraces(root: Root, indices: number[] | number): Promise<PlotlyHTMLElement>;
export declare function moveTraces(
    root: Root,
    currentIndices: number[] | number,
    newIndices?: number[] | number,
): Promise<PlotlyHTMLElement>;
export declare function extendTraces(
    root: Root,
    update: Data | Data[],
    indices: number | number[],
    maxPoints?: number,
): Promise<PlotlyHTMLElement>;
export declare function prependTraces(
    root: Root,
    update: Data | Data[],
    indices: number | number[],
): Promise<PlotlyHTMLElement>;
export declare function toImage(root: RootOrData, opts?: ToImgopts): Promise<string>;
export declare function downloadImage(root: RootOrData, opts: DownloadImgopts): Promise<string>;
...
export declare function addFrames(root: Root, frames: Array<Partial<Frame>>): Promise<PlotlyHTMLElement>;
export declare function deleteFrames(root: Root, frames: number[]): Promise<PlotlyHTMLElement>;
export declare function register(modules: PlotlyModule | PlotlyModule[]): void;
